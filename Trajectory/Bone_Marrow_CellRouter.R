...
source('cellrouter-master/CellRouter_Class.R')
libdir <- 'cellrouter-master/CellRouter/'
library(dplyr)
library(plotrix)
matrix=read.table("HP1/cellrangerRkit/HP1P_outs/outs/analysis/tsne/2_components/projection.csv",sep=",",header=T,row.names=1)
